...
public class EnseignantPlanningFragment extends Fragment {
    ...
    public EnseignantPlanningFragment() {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setHasOptionsMenu(true); // Active le menu dans ce fragment
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        enseignantId = FirebaseAuth.getInstance().getCurrentUser().getUid();
    ...
    private void decalerSemaine(int nbSemaines) {
        ...
        updateHeaderDays();
        chargerSeancesEnseignant(); // recharge les séances pour la nouvelle semaine
    }
